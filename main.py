...
ducky_instantce = ducky(WINDOW, DUCKY_IDLE_01, (900, 400))
move = True
...
while run:
    ...
    pygame.draw.circle(transparent_surface, (0, 0, 0), ducky_instantce.position + (50, 50), 60)
    ...
    #Move to Random Locations and set animations
